    ...
    <div className='flex flex-col items-center justify-center h-full'>
      <div className='max-w-lg mx-auto my-10 bg-surface rounded-lg shadow-md p-5'>
        ...
        <div className='mt-5'>
          ...
          <p className='mt-2'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi placerat lectus tincidunt
            gravida pulvinar. Cras viverra tempus purus sed fermentum. Suspendisse potenti. Ut magna urna, dignissim in
            varius sed, aliquet at nibh. Sed varius urna nunc, ac elementum tellus interdum a. Curabitur nec vestibulum
            est.</p>
        </div>
      </div>
    </div>
